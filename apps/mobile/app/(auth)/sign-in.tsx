...
const styles = StyleSheet.create({
  ...
  logo: { fontSize: 26, fontWeight: '700', color: '#0f7a67', textAlign: 'center', marginBottom: 4 },
  ...
  button: { backgroundColor: '#0f7a67', borderRadius: 10, padding: 14, alignItems: 'center', marginTop: 4 },
