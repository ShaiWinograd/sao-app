...
export const JobSchema = z.object({
  ...
  traineeName: z.string().trim().min(1).nullable().optional(),
  traineeHourlyWage: z.number().min(0).nullable().optional(),
  traineeApprovedHours: z.number().min(0).nullable().optional(),
